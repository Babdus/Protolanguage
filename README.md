...
*[Go to homepage](https://babdus.github.io/Protolanguage/Front/home.html "Protolanguage reconsturuction tool")*
...
*პირველი ხე [ასე გამოიყურება](https://babdus.github.io/Protolanguage/Data/trees/tree.html "Reconstructed tree 1")*
...
[სიტყვებს შორის მანძილების](#სიტყვებს-შორის-მანძილი "სიტყვებს შორის მანძილი") დათვლა მოხდება Damerau–Levenshtein-ის edit distance-ის გავრცობილი ვარიანტით, რომლის მიხედვითაც მხარდაჭერილია 6 ოპერაცია:

* ფონემის ჩანაცვლება ერთი მახასიათებლით განსხვავებული ფონემით

  *მაგლითად*: სიმშილი -> შიმშილი. სადაც /s/ შეიცვალა /ʃ/-თი, რომელთა ერთადერთი განმასხვავებელი მახასიათებელი არის საწარმოთქმო ადგილი: წინანუნისმიერი შეიცვალა უკანანუნისმიერით. ანუ ამ შემთხვევაში (თუ დავუშვებთ რომ ყველა ცვლილების [წონა](#ბგერითი-მახასიათებლის-ცვლილების-წონა "ბგერითი მახასიათებლის ცვლილების წონა") ჯერ-ჯერობით 1-ია) ამ ორ სიტყვას შორის მანძილი არის 1.
...
ორი სიტყვისგან მშობელი სიტყვის მიღება ისევ [ზემოთ](#სიტყვების-შედარება "სიტყვების შედარება") აღწერილი სიტყვების შედარების მეთოდით მოხდება, ანუ დავითვლი უმოკლეს გზას საიდანაც ეს ორი შვილი სიტყვა შეიძლება მიგვეღო.
...
შემდეგ ამ ინფორმაციას გამოვიყენებთ იმისათვის რომ თავიდან ჩავატაროთ [ხის დაგენერირების](#ხის-აგება "ხის აგება") პროცესი, ოღონდ ამ შემთხვევაში [სიტყვებს შორის მანძილი](#სიტყვების-შედარება "სიტყვების შედარება") დაითვლება იმავე ალგორითმით, რომელიც გაითვალისწინებს ფონემის მახასიათებლების [ერთმანეთში გადასვლის ალბათობებს](#ბგერითი-მახასიათებლის-ცვლილების-წონა "ბგერითი მახასიათებლის ცვლილების წონა"), რომლებიც მანქანური სწავლით ვისწავლეთ.
